...
//	public static void resolverAlgoritmo(Grafo grafo, Nodo origen){
//		ResultadoDijkstra result = analizarDistancias(grafo, origen);
//		System.out.println(result.getDistancias());
...
//	}
	...
	public static class ResultadoDijkstra{
		...
		public List<Nodo> getCaminoCompleto(Grafo g, Nodo destino){
